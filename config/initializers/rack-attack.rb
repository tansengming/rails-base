class Rack::Attack
  PATH_BLACKLIST = %w{/login.action /ServiceLogin /trackback /webdav /IPC$}
  ...
  # throttle('logins/ip', :limit => 25, :period => 20.seconds) do |req|
  ...
  # on wood!)
  # throttle("logins/email", :limit => 25, :period => 20.seconds) do |req|
  #   if req.path == '/users/sign_in' && req.post?
