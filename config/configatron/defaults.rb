...
configatron.stripe.secret_key      = RAILS_SECRETS.stripe_secret_key || ENV['STRIPE_SECRET_KEY']
configatron.stripe.publishable_key = RAILS_SECRETS.stripe_publishable_key || ENV['STRIPE_PUBLISHABLE_KEY']
